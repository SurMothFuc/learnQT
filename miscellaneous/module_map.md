...
| 预设与回归 | [`resources/scenes/`](../resources/scenes), [`tests/`](../tests), [`CMakeLists.txt`](../CMakeLists.txt) | 卧室/路灯声明式预设；8 项 CTest 覆盖导入、场景往返/便携包、实际 UI 切换和 GPU 像素检查。 | 先看 [v1 验收说明](./texture_scene_v1.md)。 | 测试资源、Qt/OpenGL、Python | 资源可复现性、格式和画面回归 |
